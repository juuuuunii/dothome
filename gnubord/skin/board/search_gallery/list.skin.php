...
<script src="<?php echo $board_skin_url ?>/js/hover.zoom.js"></script>

<script>
	$(function() {
		var bo_gallery_width = "<?php echo $board['bo_gallery_width']; ?>";
		var bo_gallery_height = "<?php echo $board['bo_gallery_height']; ?>";
		
		$('.zoom').css({"width":bo_gallery_width});
		$('.zoom').css({"height":bo_gallery_height});
		$('.fd-zoom').hoverZoom({
                overlay: <?php echo $board['bo_1']; ?>, // false to turn off (default true)
                overlayColor: "<?php echo $board['bo_2']; ?>", // overlay background color
                overlayOpacity: <?php echo $board['bo_3']; ?>, // overlay opacity
                zoom: <?php echo $board['bo_4']; ?>, // amount to zoom (px)
                speed: <?php echo $board['bo_5']; ?> // speed of the hover
            });
	}); 
</script>
...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con">
                <li class="gall_href zoom">
                    <a href="<?php echo $list[$i]['href'] ?>" class="fd-zoom">
                    <?php
                    ...
                    <?php } else {
                        ...
                        if($thumb['src']) {
                            $img_content = '<img src="'.$thumb['src'].'" class="fd-gal-img" alt="'.$thumb['alt'].'">';
                        } else {
